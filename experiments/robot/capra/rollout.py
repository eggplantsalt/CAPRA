...
if TYPE_CHECKING:
    ...
    from experiments.robot.capra.task_progress import ProgressFn
...
def short_cf_rollout(
    ...
    from experiments.robot.capra.snapshot import restore_snapshot
    from experiments.robot.capra.signals import read_state_signals
    from experiments.robot.capra.footprint import aggregate_footprint_components, compute_footprint
    from experiments.robot.capra.task_progress import make_libero_progress_fn, compute_progress_from_rollout
